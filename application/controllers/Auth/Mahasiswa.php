...
class Mahasiswa extends CI_Controller {
	...
	{
        $data['data'] = $this->MahasiswaModel->tampil_semua()->result();
    ...
    public function edit($id)
    {
        ...
        $data['data'] = $this->MahasiswaModel->tampil_edit($where, 't_user')->result();
        $this->load->view('public/component/header');
		$this->load->view('public/component/menu');
    ...
    function update(){
        ...
        $this->MahasiswaModel->update_data($where,$data,'t_user');
        redirect('/auth/mahasiswa');
    }

    function hapus($id){
      $where = array('id_user' => $id);
      $this->MahasiswaModel->hapus_data($where,'t_user');
      redirect('/auth/mahasiswa');
    }
