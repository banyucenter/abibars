...
<script src="<?php echo base_url().'assets/frontend/plugins/jquery-ui-1.12.1.custom/jquery-ui.js';?>"></script>
<script src="<?php echo base_url().'assets/frontend/js/categories_custom.js';?>"></script>
</body>
