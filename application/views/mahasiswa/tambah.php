...
<div class="container product_section_container">
    ...
    <form action="<?php echo base_url(); ?>auth/mahasiswa/aksi_tambah" method="post" enctype="multipart/form-data">
    <div class="form-row">
        <div class="form-group col-md-6">
        <label for="inputPassword4">NIM</label>
        <input type="text" name="no_identitas" class="form-control" id="inputPassword4" required placeholder="Nomor Induk Mahasiswa">
